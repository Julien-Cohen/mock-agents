...
from a2a.client import A2ACardResolver, ClientConfig, create_client, ClientCallContext
    ...
    async for event in stream:
        ...
        if not current_task_id:
            if event.HasField('task'):
                ...
                print(f'Unexpected first event: {event}')
...
async def main() -> None:
    ...
    parser.add_argument(
        '--url', default='http://127.0.0.1:9999', help='Agent base URL'
    )
    parser.add_argument(
        '--transport',
        default=None,
